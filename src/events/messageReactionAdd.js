		...
		if (reaction.message.author.id == "432610292342587392") {
			if (reaction.message.embeds.length > 0) {
				for (var i = 0; i < reaction.message.embeds.length; i++) {
					if (reaction.message.embeds[i].author.name.toLowerCase().includes("mai sakurajima") || reaction.message.embeds[i].author.name.toLowerCase().includes("kirito") || reaction.message.embeds[i].author.name.toLowerCase().includes("ray") || reaction.message.embeds[i].author.name.toLowerCase().includes("ray") || reaction.message.embeds[i].author.name.toLowerCase().includes("eugeo") || reaction.message.embeds[i].author.name.toLowerCase().includes("aqua") || reaction.message.embeds[i].author.name.toLowerCase().includes("creati") || reaction.message.embeds[i].author.name.toLowerCase().includes("ken kaneki") && (reaction.emoji.name != "wright" && reaction.emoji.name != "wleft")) {
